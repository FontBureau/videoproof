 ...
 */
export function markupSelection(rootElement, class_, normalizedMergedPathRanges) {
 ...
 */
export function markupSelection2(rootElement, class_, normalizedMergedPathRanges) {
    // Clean up
    // CAUTION: if rootElement has changed/the wrong content,
    //          the selection will be invalid/different anyways.
