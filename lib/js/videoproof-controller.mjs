...
export class VideoproofController {
    ...
    async _initUI({mainUIElement, charGroups}) {
        ...
        let setColorsHandler= ()=>{
            // In this case not going via _uiSetAnimatonState makes
            // changing colors very smooth, even during animation.
            // Maybe, throttling the calls to _uiSetAnimatonState
    ...
    _uiInitProof() {
        ...
        // this._uiSetAnimatonState();
        // _uiSetAnimatonState should call this function when necessary,
        // not the other way around.
        console.warn('NOT calling _uiSetAnimatonState (via _uiInitProof) ...');
    }
    ...
    setState(state) {
        ...
        this._uiSetAnimatonState(); // calls itself this._uiInitProof();
