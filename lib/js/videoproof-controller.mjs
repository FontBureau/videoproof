...
class AnimationStateMoar extends _AnimationState {
    constructor(generator, keyFrames, baseAnimationState) {
        super(generator, keyFrames);
        Object.defineProperty(this, 'baseAnimationState', {
            value: baseAnimationState,
            writable: false,
            enumerable: true
        });
    }
...
export class VideoproofController {
    ...
    _moarActivate(axisTag, genControl={}) {
        ...
        let keyFrames = Array.from(calculateKeyframes(orderedFilteredAxisRanges))
          ...
          ;
        this._ui.duration.value = duration;
        let animationState = new AnimationStateMoar(gen, keyFrames, baseAnimationState);
        this._setAnimationState(animationState);
    }
    ...
    _initMoarAnimationLinks() {
        ...
        for (let axis of axes) {
            ...
            a.addEventListener('click', ()=>this._moarActivate(axis.tag)); // jshint ignore:line
        }
    }
    ...
    _uiSetAnimatonState() {
        ...
        let animationState = this._animationState.lastYield
          ...
          , {status, axesInfo, proof, keyFramesContainer} = this._ui
