...
class UINummberAndRangeInput extends _UIBase {
    ...
    get value (){ return this._inputs[0].value; }
    set value(val) {
        for(let input of this._inputs)
            input.value = val;
    }
    ...
    async _initUI({mainUIElement, charGroups}) {
        ...
        this._ui = {   status, proof, keyFramesContainer, moarAxesContainer
                     ...
                     , multipleTargets: new UIMultipleTargets(
                      ...
                      , columnWidth: new UINummberAndRangeInput(
                            {
                            ...
                            {min: 10, max: 80, step: 0.1, value: 40}
                        )
