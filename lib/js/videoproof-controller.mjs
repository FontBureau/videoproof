...
export class VideoproofController {
    ...
    // but that could also be handled in this._uiSetState
    ...
    _uiInitProof() {
        ...
        // this._uiSetState();
        // _uiSetState should call this function when necessary,
        // not the other way around.
        console.warn('NOT calling _uiSetState (via _uiInitProof) ...');
    }
    ...
    setState(state) {
        ...
        this._uiSetState(); // calls itself this._uiInitProof();
