...
class UIMultipleTargets extends _UIBase {
    ...
    initTargets (amountOfTargets, uiStateFields, defaults) {
        ...
        console.log('multipleTargets this.states after initTargets', this.states);
        return this.states;
    }
