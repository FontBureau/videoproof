...
import { getPositionKey, rangeToLog, normalizeRanges
       , pathRangesForLog, mergePathRanges, markupSelection
        ...
        doc.addEventListener('selectionchange', (evt)=>{
            ...
            if(this._uiSelection.currentStartKey && this._uiSelection.currentStartKey !== startKey) {
                ...
                if(!this._uiSelection.currentRange.collapsed) {
                    ...
                    let normalizedCurrent =  normalizeRanges(proof, this._uiSelection.currentRange);
                    ...
                    // console.log('after normalization', pathRangesForLog(...normalizedPathRanges));
                    ...
                    let mergedRanges = mergePathRanges(...this._uiSelection.ranges, ...normalizedCurrent);
                    console.log('mergedRanges', pathRangesForLog(...mergedRanges));
                    this._uiSelection.ranges.splice(0, this._uiSelection.ranges.length, ...mergedRanges);

                    markupSelection(proof, mergedRanges);
                }
            }
