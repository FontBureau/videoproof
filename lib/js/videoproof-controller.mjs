...
export class VideoproofController {
    ...
    async _initUI({mainUIElement, charGroups}) {
        ...
        selectLayout.addEventListener('change', (/*e*/)=>this._uiSetState());
    ...
    __uiSetState() {
        ...
        // Updating Animation links
        // FIXME: do we detect font change like this?
        // FIXME: fontName change may not be sufficient in the future to
        //        detect when to update the several keyframe links.
        //        E.g. we may create custom animations in the future, so
        //             the same fontName will have dfferent Keyframes
    ...
    setState(state) {
        ...
        // FIXME: It would be ideal to call _uiSetState inderectly via
        //          this._stateChangeHandler(...dependencyNames)
        this._uiSetState();
