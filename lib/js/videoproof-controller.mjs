...
export class VideoproofController {
    ...
    async _activateLoadedFont(fontName) {
        // activateFont will only set this._currentFont if it finds
    ...
    async activateFont(fontName) {
        ...
        if(!this._mainUIElement) {
            console.warn(`activateFont: No ui element available yet ${fontName}.`);
            return false;
        }
        ...
        proof.style.setProperty('font-family', fontName);
