...
const FontModel = _AbstractGenericModel.concreteFactory('FontModel')
  ...
  , AxisLocationsModel = _AbstractOrderedMapModel.concreteFactory('AxisLocationsModel', AxisLocationModel)
    /*
  ...
  */
  , ExampleLayoutModel = _AbstractStructModel.concreteFactory(
      ...
      , [REQUIRES, 'font'/*, 'layout' */ , 'more', function(/*changedSet ???, */{font}, valueMap) {
            ...
            const changedSet = null;
            console.log(`${this} coherence method changedSet:`, changedSet, 'font', font, 'valueMap', valueMap);
        }]
  ...
  , AvailableLayoutsModel = _AbstractOrderedMapModel.concreteFactory('AvailableLayoutsModel', ExampleLayoutModel)
  , AvailableFontsModel = _AbstractOrderedMapModel.concreteFactory('AvailableFontsModel', FontModel)
  , ApplicationModel = _AbstractStructModel.concreteFactory(
        'ApplicationModel'
        // , [REQUIRES, 'templates'] // => just to see the NOT IMPLEMENTED message.
      , [REQUIRES, 'templates'/*, 'layout' */ ,  function(/*changedSet ???, */{templates}, valueMap) {
            const changedSet = null;
            console.log(`${this} coherence method changedSet:`, changedSet, 'templates', templates, 'valueMap', valueMap);
        }]
      ...
      , ['availableFonts', AvailableFontsModel] // ordered map, all of type FontModel
        ...
        //
      , ['activeFontKey', new ForeignKey('availableFonts', ForeignKey.NOT_NULL)]
        ...
        // ValueLink => value
      , ['font', new KeyValueLink('activeFontKey')] // => provides one FontModel of AvailableFontsModel

      , ['availableLayouts', AvailableLayoutsModel]
      , ['activeLayoutKey', new ForeignKey('availableLayouts', ForeignKey.NOT_NULL)]
      , ['layout', new KeyValueLink('activeLayoutKey')]
      /*
