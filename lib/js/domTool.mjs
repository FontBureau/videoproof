...
export default class DOMTool {
  ...
  static createElementfromHTML(...args) {
      return this.createElementFromHTML(...args);
  }
  ...
  static createElementfromMarkdown(...args) {
      return this.createElementfromMarkdown(...args);
  }
  ...
  createElementfromMarkdown(...args) {
      return this.createElementFromMarkdown(...args);
  }
