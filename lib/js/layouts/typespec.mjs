...
export function init(proofElement, domTool, templateElement, setActiveTypoTarget, activeTypoTargetIndex, states) {
    ...
    proofElement.append(templateElement);
    {
        ...
        let allTypoTargets = proofElement.querySelectorAll(TYPO_ELEMENT_SELECTOR);
        console.log('activeTypoTargetIndex', activeTypoTargetIndex,
                `TYPO_ELEMENT_TARGET_SELECTOR ${TYPO_ELEMENT_TARGET_SELECTOR}:`, allTypoTargets);
        _activateTypoTarget(allTypoTargets, activeTypoTargetIndex);
        setActiveTypoTarget(activeTypoTargetIndex);
    }

    return {
        update: (activeTypoTargetIndex, states)=>{
            console.log('typespec !UPDATE!:', activeTypoTargetIndex, states);
        }
    };
