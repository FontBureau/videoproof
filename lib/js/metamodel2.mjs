...
function getTopologicallySortedOrder(coherenceFunctions, fields, foreignKeys
            , links, internalizedDependencies, childrenExternalDependencies) {
    ...
    const noDepsSet = new Set(allKeys(childrenExternalDependencies, coherenceFunctions
...
export class _AbstractStructModel extends _BaseContainerModel {
    ...
    static createClass(className, ...definitions) {
        ...
        const fields = new FreezableMap()
          ...
          // FIXME: related internalizedDependencies
        ...
        // FIXME: However this.has doesn't look at coherenceFunctions at
        //        all, so this seems to be a misunderstanding
        //        also, so far, coherenceFunctions (or their return values)
        //        are not really treated as part of the namespace.
        const staticHas = this.has.bind({fields, foreignKeys, links, internalizedDependencies, coherenceFunctions})
          ...
          , dependencies = new FreezableSet([ //jshint ignore: line
                      ...
                      // FIXME: related internalizedDependencies, maybe
                      // the name of these should apply here? Not sure how
                      // this was supposed to work in detail...
          ...
          , initOrder = getTopologicallySortedOrder(coherenceFunctions, fields //jshint ignore:line
                            , foreignKeys, links, internalizedDependencies
                            , childrenExternalDependencies)
          ;
