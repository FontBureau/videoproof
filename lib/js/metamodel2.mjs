    ...
    *[Symbol.iterator]() {
    ...
    keyToIndex(key) {
        ...
        if(index < 0 || index >= this._value.length)
           return [null, `KEY ERROR NOT FOUND key "${stringKey}" is not an index (= ${index})`
...
export class Path {
    ...
    toString(defaultAnchoring=null /*ROOT || RELATIVE || null */) {
        ...
        return (anchoring === null
                        ? this.parts
                        : [anchoring === this.constructor.SEPARATOR ? '' : anchoring, ...this.parts]
...
export function getEntry(state, path, defaultVal=_NOTDEF) {
    ...
    try {
        return [...pathInstance.parts].reduce((accum, part)=>{
    ...
    constructor(newState, dependencies=null, anchoring=Path.ROOT /* null || Path.ROOT || Path.RELATIVE */){
        ...
        const compareResultEntries = []
          , paths = dependencies === null
                ? Array.from(getAllPathsAndValues(newState))
                     .map(([/*value*/, ...parts])=>{
                         return anchoring === null
