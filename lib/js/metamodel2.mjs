...
class _PotentialWriteProxy {
    ...
    static create(parent, immutable, key=null) {
        ...
        // Very special case, the idea is that the wrapped child is
        // not proxified as the wrapper takes care of all the duties.
        if(parent instanceof _AbstractDynamicStructModel && immutable instanceof parent.WrappedType)
            // Attempt to not proxy and trap the wrapped type.
            return immutable;
...
export class _AbstractDynamicStructModel extends _BaseContainerModel {
    ...
    [_GET_DRAFT_FOR_OLD_STATE_KEY](key) {
        ...
        console.log('_GET_DRAFT_FOR_OLD_STATE_KEY', key, item);
