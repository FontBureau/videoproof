 ...
 *
 * This is used as a base for KeyValueModel and there are expectations
 * to it:
 *
 *     dependencies => EMPTY_SET
 *     isDraft => bool
 *     createPrimalState() => an immutable, value === undefined
 *     getDraft() => a draft
...
export  class _AbstractGenericModel extends _BaseModel {
    ...
    constructor(oldState=null) {
        ...
        // A primal state will have a value of undefinded.
        Object.defineProperty(this, 'value', {
