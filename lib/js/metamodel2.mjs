...
export class _AbstractStructModel extends _BaseContainerModel {
    ...
    constructor(oldState) {
        ...
        //      this.metamorphose(dependencies);
        // The problem is though, that we don't know the dependencies yet,
        // hence, this is not possible.
        // FIXME: This object, as a draft, without OLD_STATE is unusable.
        //
    }
    ...
    metamorphose(dependencies={}) {
        ...
        const entries = this.value
          ...
          , lockItem(name) {
                ...
                // ValueLink is skipped width `this.has(name)` and
                // requires no locking itself.
        ...
        // compare
        if(this[OLD_STATE] && changedDependencyNames.size === 0 && changedValues === 0)
            // Has NOT changed!
            return this[OLD_STATE];
